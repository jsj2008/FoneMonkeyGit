...
//  FoneMonkey
//
//  Created by Kyle Balogh on 10/6/11.
//  Copyright 2011 Gorilla Logic, Inc. All rights reserved.
//

#import "FMOptionsView.h"
#import "FMUtils.h"


@implementation FMOptionsView
...
- (id) initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        delayTextField.text = [FMUtils retrieveUserDefaultsForKey:@"FMDelay"];
        ...
        retryTextField.text = [FMUtils retrieveUserDefaultsForKey:@"FMRetry"];
...
- (void) textInput:(id)sender
{
    ...
    if (textField.tag == 0)
        [FMUtils saveUserDefaults:textField.text forKey:@"FMDelay"];
    else
        [FMUtils saveUserDefaults:textField.text forKey:@"FMRetry"];
}
