...
//    if (!executed)
//    {
//        FMWebViewController *webViewController = (FMWebViewController *)[self viewController];
...
//      NSLog(@"error: %@",resultDict);
      ...
      //FMWebViewController *FMWebViewController = (FMWebViewController *)[self viewController];
...
-(id) executeAsyncJsFunction:(NSString*)script
  ...
  // The |FMWebViewController| will broadcast a |webdriver:executeAsyncScript|
